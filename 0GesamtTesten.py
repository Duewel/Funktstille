...
paths = [os.path.join("uploads", basename) for basename in files]
test_path = max(paths, key=os.path.getctime)


# Beispiel-Daten initialisieren (ersetzen Sie dies durch Ihren tatsächlichen Pfad und Ihre Daten)
#test_path = "uploads/2024-06-18_13_57_11_my_iOS_device.csv"   #"new/D- Park.csv"
